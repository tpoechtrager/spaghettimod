--[[
  ...
  Warning: This mod is unfinished and might cause a high CPU usage with many players.
...
--[[ 
    ...
    to update its position/appearance on the client side. Somewhat like std.trackent, but still needs optimization.
]] 
